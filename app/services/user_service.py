...
def create_user(
    ...
    if create_player_profile:
        ...
        if new_player is not None and club_id is not None:
...
def assign_role(
    ...
    # If the user has a linked player profile, keep player.club_id in sync so
    # they appear in the club's player list and can be registered for seasons.
